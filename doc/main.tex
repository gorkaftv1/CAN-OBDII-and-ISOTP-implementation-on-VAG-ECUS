...
La motivación inicial para el desarrollo de este trabajo ha sido el interés en el mundo de la automoción y la monitorización de vehículos, así como la necesidad de contar con herramientas que permitan acceder a los datos de los vehículos de forma completamente inalámbrica.
...
En esta primera fase se han identificado los requisitos del sistema y se han estudiado los protocolos de comunicación que usa el SEAT Ibiza 6j, para poder empezar con el diseño de la infraestrctura de monitorización y comunicación con las distintas ECUs del vehículo.
